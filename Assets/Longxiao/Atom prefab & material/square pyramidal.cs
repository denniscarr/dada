...
public class squarePyramidal : MonoBehaviour {
    ...
    void Start () {
        ...
        GameObject boundingKey5 = Instantiate(key, key2, Quaternion.Euler(0, 0, 0));
       // GameObject boundingKey6 = Instantiate(key, key3, Quaternion.Euler(0, 0, 0));
