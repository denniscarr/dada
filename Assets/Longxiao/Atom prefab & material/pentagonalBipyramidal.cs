...
public class pentagonalBipyramidal : MonoBehaviour {
    ...
    void Start () {
        ...
        Vector3 key2 = centerAtom.transform.position + new Vector3(0, ((centerAtom.transform.localScale.y) / 2) + 0.4f, 0);
        Vector3 key3 = centerAtom.transform.position + new Vector3(0, -((centerAtom.transform.localScale.y) / 2) - 0.4f, 0);
        ...
        GameObject boundingKey4 = Instantiate(key, key1, Quaternion.Euler(0, 0, 90));
        GameObject boundingKey5 = Instantiate(key, key1, Quaternion.Euler(0, 0, 90));
        GameObject boundingKey6 = Instantiate(key, key2, Quaternion.Euler(0, 0, 0));
        GameObject boundingKey7 = Instantiate(key, key3, Quaternion.Euler(0, 0, 0));
        ...
        boundingKey2.transform.RotateAround(centerAtom.transform.position, centerAtom.transform.up, 72);
        boundingKey3.transform.RotateAround(centerAtom.transform.position, centerAtom.transform.up, 144);
        boundingKey4.transform.RotateAround(centerAtom.transform.position, centerAtom.transform.up, 216);
        boundingKey5.transform.RotateAround(centerAtom.transform.position, centerAtom.transform.up, 288);
